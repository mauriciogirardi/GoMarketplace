<h1 align='center' >
  <img src='.github/Logo.png' alt='GoMarketplace' />
<h1>

## :pencil2:  Layout

<div align='center'>
  <img src='.github/Listagem.png' alt='Listagem' width='200' />
  <img src='.github/Carrinho.png' alt='Carrinho' width='200' />
</div>


## :rocket: Sobre o desafio

Nesse desafio, tivemos que desenvolverá uma nova aplicação, a GoMarketplace.
Para praticar o que aprendemos até agora 
no React Native junto com o TypeScript, utilizando rotas, Async Storage e a Context API.
...
Esse projeto está sob a licença MIT. Veja o arquivo [LICENSE](https://github.com/mauriciogirardi/GoMarketplace/blob/master/LICENSE) para mais detalhes.
